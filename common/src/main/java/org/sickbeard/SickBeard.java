...
import org.sickbeard.model.deserializer.JsonBooleanDeserializer;
...
public class SickBeard {
	...
	public Episode episode(String tvdbid,
									   String season,
									   String episode,
	...
	public boolean episodeSetStatus( String tvdbid, String season, String episode, Status status ) throws Exception
	{
	...
	public boolean episodeSetStatus( String tvdbid, List<SeasonEpisodePair> episodes, Status status ) throws Exception
	{
	...
	public boolean showAddNew(String tvdbid, Language language, Boolean seasonFolders, Status status, EnumSet<Show.Quality> initial, EnumSet<Quality> archive ) throws Exception
	{
...
//		return server.getInputStream();
	...
	public boolean showSetQuality(String tvdbid, EnumSet<Show.Quality> initial, EnumSet<Show.Quality> archive ) throws Exception
	{
