...
import org.sickbeard.model.EpisodeJson;
...
public class Episode {
	...
	public enum Status {
		...
		public static Status[] valuesSetable()
		{
			if ( setable == null ) {
				setable = new Status[]{WANTED, SKIPPED, ARCHIVED, IGNORED};
			}
			return setable;
		}
		...
		public static Status fromJson(String statusString )
		{
		...
		public static Status fromOrdinal(int index)
		{
