...
This repository contains the source code for the [nzbOne](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.nzbone).

Please see the [issues](https://github.com.nzbone/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about nzbOne? Ask away on the [com-nzbone discussion forum](https://groups.google.com/forum/#!forum/com-nzbone). 

<a href="https://play.google.com/store/apps/details?id=com.nzbone" alt="Download from Google Play">
...
At that point all the source files that were located in ____com.nzbone__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.nzbone.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall nzbOne from your device and
...
You can then import the nzbOne project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the nzbOne directory.  Click
...
nzbOne is a result of a template project I've developed over the years as well as
...
nzbOne is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.nzbone/contributors) on this project. Your help is much appreciated.


## Contributing

Please fork this repository and contribute back using
[pull requests](https://github.com.nzbone/pulls).
